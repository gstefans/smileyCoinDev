...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " smileycoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  smileycoin-tx [options] <hex-tx> [commands]  Update hex-encoded smileycoin transaction\n" +
            "or:     smileycoin-tx [options] -create [commands]   Create hex-encoded smileycoin transaction\n" +
            "\n";
