...
const char* BIP71_MIMETYPE_PAYMENT = "application/smileycoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/smileycoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/smileycoin-paymentrequest";
#endif
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("smileycoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'smileycoin://' is not a valid URI. Use 'smileycoin:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Smileycoin address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
